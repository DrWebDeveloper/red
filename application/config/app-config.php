...
switch ($dom)
{
    case 'redacteuronline.com':
        $site_id = 'https://redacteuronline.com/';
        break;
    case 'localhost':
        $site_id = 'http://localhost/r/';
        break;
    case 'ikoproject.com':
...
*/
define('APP_ENC_KEY', '7be2d785bbcefa4cb76790e62c58c1ec');
...
// define('APP_DB_USERNAME', 'red_perfex');1
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', '');
// define('APP_DB_PASSWORD', 'Leplebs2212*');1
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'red_perfex');
/**
 * @since  2.3.0
 * Database charset
 */
