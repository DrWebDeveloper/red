...
<aside id="menu" class="sidebar">
   <script>
      $(document).ready(function() {
         $(".menu-item-subscriptions").hide();
         $(".menu-item-expenses").hide();
         $(".menu-item-contracts").hide();
         $(".menu-item-knowledge-base").hide();
      });
   </script>
   <ul class="nav metis-menu" id="side-menu">
      ...
      <li class="menu-item-products">
            ...
            <ul class="nav nav-second-level collapse" aria-expanded="false">
               <li class="sub-menu-item-Products">
                  <a href="<?php echo base_url("/admin/forms/redaction") ?>">
                     <span class="sub-menu-text">
                        Redaction </span>
                  </a>
               </li>
               <li class="sub-menu-item-products_categories">
                  <a href="<?php echo base_url("/admin/forms/correction") ?>">
                     <span class="sub-menu-text">
                        Correction </span>
                  </a>
               </li>
