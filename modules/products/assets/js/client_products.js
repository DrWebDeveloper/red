...
function render_product_data(data) {
    ...
    $.each(data, function(index, val) {
        ...
        if (parseInt(val.quantity_number) < 1 && val.is_digital != 1) {
            ...
            button = `<button class="btn btn-block btn-warning add_cart pull-right">${label}</button>`
        }
                ...
                <div>
                    ...
                    <div class="row input_data" id="">
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <input type="hidden" name="quantity" value="1" class="form-control" placeholder="${val.qty}">
