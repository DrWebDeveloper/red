                     ...
                     <tbody>
                        <?php foreach ($products as $key => $product) { ?>
                            ...
                            <tr nobr="true">
                                ...
                                <td align="" width="10%">
									<span ><strong><?php echo htmlspecialchars($product->quantity); ?></strong></span>
                                    <?php
                                        $qty_attr = [
                                    ...
                                    ?>
                                    <?php echo render_input('product_items['.$product->id.'][qty]', '', $product->quantity, 'hidden', $qty_attr, [], '', ' quantity'); ?>
...
<div class="panel_s section-heading section-products">
    <div class="panel-body">
		...
		<button class="btn btn-success pull-right"><i class="fa fa-check"></i> <?php echo _l('invoice_to_pay'); ?></button>
    </div>
</div>
<?php echo form_close(); ?>
