...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 11, 2021 at 10:02 AM
...
CREATE TABLE `tblforms` (
  ...
  `professional_price` int(11) NOT NULL,
  ...
  `box1_price` int(11) NOT NULL,
  `box2_price` int(11) NOT NULL,
  `box3_price` int(11) NOT NULL,
  `box4_price` int(11) NOT NULL,
  `required` tinyint(1) NOT NULL DEFAULT 0,
  `type` varchar(20) NOT NULL,
  `options` mediumtext DEFAULT NULL,
  `active` int(11) NOT NULL DEFAULT 1,
...
INSERT INTO `tblforms` (`id`, `name`, `slug`, `no_texts`, `no_words`, `basic_desc`, `standard_desc`, `professional_desc`, `basic_price`, `standard_price`, `professional_price`, `box1_title`, `box2_title`, `box3_title`, `box4_title`, `box1_desc`, `box2_desc`, `box3_desc`, `box4_desc`, `box1_price`, `box2_price`, `box3_price`, `box4_price`, `required`, `type`, `options`, `active`, `default_value`) VALUES
(1, 'redaction', 'Test', '1,2,3,3,5,5,6,7,5,6,9,8', '1,2,3', NULL, '', '', 0, 0, 0, '', '', '', '', '', '', '', '', 0, 0, 0, 0, 1, 'text', 'TestTestTest', 1, 'Test'),
(2, 'correction', 'Test', '1,2,3,4,5,6,7,8,9', NULL, NULL, '', '', 0, 0, 0, '', '', '', '', '', '', '', '', 0, 0, 0, 0, 1, 'text', 'TestTestTest', 1, 'Test');
...
('0gfr9tp6i1i14fnp3cv1drfio83iripu', '::1', 1628668876, 0x5f5f63695f6c6173745f726567656e65726174657c693a313632383636383836333b73746166665f757365725f69647c733a313a2231223b73746166665f6c6f676765645f696e7c623a313b),
...
(1, 'admin@admin.com', 'Julien', 'Dupuis', '', '', '', '', '$2a$08$xHU3b88MMIokvGSFBKeCh.50k.Wctgi9d2Fhi1y5Yzb9XCDMlDPC.', '2021-06-19 04:54:46', 'depositphotos_179308454-stock-illustration-unknown-person-silhouette-with-glasses.jpg', '::1', '2021-08-11 10:01:11', '2021-08-11 10:01:11', NULL, NULL, NULL, 1, 0, 1, 'french', '', NULL, 0, '0.00', 0, NULL, NULL, '', NULL),
